 ...
 * dados do questionário referente ao primeiro Alien 2.
 */
package programaalienigenaoo;

public class Identidade2 {
    ...
    public Identidade2(String nome, String raca, String planeta, double altura, double peso) {
        this.nome = nome;
        this.raca = raca;
